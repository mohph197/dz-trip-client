...
const Header: FunctionComponent = () => {
	...
	return (
		...
		>
			...
			<nav className='fixed lg:static inset-y-0 right-0 w-[75vw] lg:w-auto flex flex-col lg:flex-row items-center justify-center gap-4 bg-background-nav bg-opacity-60 lg:bg-opacity-0 backdrop-blur lg:backdrop-filter-none z-10 translate-x-full peer-checked:translate-x-0 lg:translate-x-0 transition-transform'>
