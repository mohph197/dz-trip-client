...
const HeroSection: FunctionComponent = () => {
	return (
		...
		>
			<div className='relative h-full w-full px-14 md:px-20 flex flex-col justify-center items-center'>
				...
				<div className='h-full w-full md:w-2/5 self-start flex flex-col justify-center items-stretch gap-8'>
